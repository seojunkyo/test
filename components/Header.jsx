"use client"
import { Asterisk, MoreHorizontal, Menu, ChevronDown, User } from "lucide-react"
import { useState } from "react"
import GhostIconButton from "./GhostIconButton"
import UserPopover from "./UserPopover"

export default function Header({ createNewChat, sidebarCollapsed, setSidebarOpen, isLoggedIn, onLogout }) {
  ...
  return (
    <div className="sticky top-0 z-30 flex items-center gap-2 border-b border-zinc-200/60 bg-white/80 px-4 py-3 backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/70">
      ...
      <div className="ml-auto flex items-center gap-2">
        <UserPopover onLogout={onLogout}>
          <button
            className={`inline-flex items-center justify-center rounded-full p-2 hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 transition-colors ${
              isLoggedIn
