...
const generateTemplateId = () => `template_${++templateIdCounter}`
...
export default function Sidebar({
  ...
  setSidebarCollapsed = () => {},
  isClient = false, // Add isClient prop to control client-only rendering
  userData = { username: "", mail: "" }, // Added userData prop
  isLoggedIn = false, // Added isLoggedIn prop
        ...
        {(open || isClient) && (
          ...
          >
            <div className="flex items-center gap-2 border-b border-zinc-200/60 px-3 py-3 dark:border-zinc-800">
              <button onClick={onResetToHome} className="flex items-center gap-2 hover:opacity-80 transition-opacity">
              ...
              <div className="mt-2 flex items-center gap-2 rounded-xl bg-zinc-50 p-2 dark:bg-zinc-800/60">
                ...
                <div className="min-w-0">
                  <div className="truncate text-sm font-medium">
                    {isLoggedIn && userData.username ? userData.username : "John Doe"}
                  </div>
                  <div className="truncate text-xs text-zinc-500 dark:text-zinc-400">
                    {isLoggedIn && userData.mail ? userData.mail : "Pro workspace"}
                  </div>
                </div>
              </div>
            </div>
