...
export const INITIAL_CONVERSATIONS = [
  {
    ...
    messages: [
      ...
      },
      {
        ...
        createdAt: new Date(baseTime - 2 * 60 * 60 * 1000 + 60000).toISOString(),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    updatedAt: new Date(baseTime - 6 * 60 * 60 * 1000).toISOString(),
    messageCount: 8,
  ...
  },
  {
    ...
    updatedAt: new Date(baseTime - 9 * 24 * 60 * 60 * 1000).toISOString(),
    messageCount: 5,
...
- Additional context:`,
    ...
    updatedAt: new Date(baseTime - 7 * 24 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: "t2",
    name: "Daily Standup",
...
- Manual testing completed?`,
    ...
    updatedAt: new Date(baseTime - 3 * 24 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: "t4",
    name: "Meeting Notes",
